...
def create(think):
    api = Text2ImageAPI('https://api-key.fusionbrain.ai/', key_api, s_key)
    model_id = api.get_model()
    uuid = api.generate(think, model_id)
    ...
    image.save("image.jpg")  # сохранение изображения на диск
    image.close()
